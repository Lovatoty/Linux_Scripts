...
function FIREWALL_DDOS_PROTECTION_RULES(){
 
	whiptail --title "DDoS Protection" --msgbox "Appling conntrack rules for DDoS Proctection" 
	echo "Applying Conntrack rules"
...
do
	...
	"a" "Apply rules for DDoS Protection" \
	"6" "Block IPv6" \
	...
	;;
	D)
	  FIREWALL_DDOS_PROTECTION_RULES
	;;
	6)
	  FIREWALL_BLOCK_IPV6
	;;
